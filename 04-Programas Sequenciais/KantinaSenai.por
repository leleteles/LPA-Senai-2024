...
programa
{
	...
	leia (qtd_sobremesa)
	/*
	 * Cáculo dos valores a serem pagos .
	 * O cálculo é feito multiplicando a quantidade de intens vendidos pelo preço de cada item
	*/
	...
	escreva("========================================\n")
	escreva ("Tota da compra: R$ ", tot_total,"\n")
